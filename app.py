...
# def draw_pokemon_url(prompt, num, type):
#     url = 'https://qnezy3td8j.execute-api.us-east-1.amazonaws.com/beta/pkgen'
#
#     data = {
#         "data": {
...
navbar = dbc.NavbarSimple(
    ...
    brand="Deep Dive into Pokémon: From Data Analytics to Futuristic Designs with ML/DL",
    color='info',
    fluid=True,
    dark=False,
...
tab2 = dbc.Tab(label='Create A Futuristic Pokémon 🎭', tab_id='tab2',
               style=tab_style, activeTabClassName="fw-bold fst-italic",
               children=[
                   html.Div(html.Br()),
                   dbc.Button('Use Deep Learning To Generate A New Pokémon', color='secondary', size='lg', outline=False,
                              style={'font-size': '30px', 'width': '100%'}),
                   html.Div(html.Br()),
                   html.H1("Create Your Own Pokémon"),
                   html.P("Select two Pokémons and style, the deep learning model would generate a new Pokémon with all characteristics for you. "\
                          "Utilize the dropdown menu to select between 'Primitive' and 'Robotic' options to generate Pokémon in different styles. "\
                            "Each choice will craft a distinct visual representation, allowing you to explore variations between traditional and futuristic Pokémon designs. "\
                                "The spawning process may take up to 10 seconds. 🔮 ",
                          style={"text-align": "left", 'font-size': '20'}),
                   html.H4(""),
                   dbc.Row([
                       dbc.Col([
                       ...
                       dbc.Col([
                           html.P('Style'),
                           dcc.Dropdown(
                               id='select-type', options=['Primitive 🦕', 'Robotic 🤖'],
                               multi=False,
                               value='Primitive 🦕'),
                           html.Div(html.Br()),
                   ...
                   html.Div(html.Br()),
                   html.P('New Pokémon: ', style={"text-align": "center", 'font-size': '50px'}),
                   dls.Hash(html.Div(id='new-pokemon-plot'), color='#435278', speed_multiplier=2, size=30,
                            fullscreen=False),
                   html.Div(html.Br()),
                   html.Div(html.Br()),
               ])

# tab3 = dbc.Tab(label='Draw A Pokémon as you wish 🔮', tab_id='tab3',
#                style=tab_style, activeTabClassName="fw-bold fst-italic",
#                children=[
#                    html.Div(html.Br()),
#                    dbc.Button('Draw A Pokémon Picture with Deep Learning', color='secondary', size='lg', outline=False,
#                               style={'font-size': '30px', 'width': '100%'}),
#                    html.Div(html.Br()),
#                    dbc.Input(id='search-input', placeholder="Describe a scenario about Pokémon", size="lg",
#                              className="mb-3"),
